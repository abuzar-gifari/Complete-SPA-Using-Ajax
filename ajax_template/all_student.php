...
?>
        ...
        <tr>
            ...
            <td><a view_id="<?php echo $single_teacher_data->id ?>" href="#" id="profile" class="btn btn-sm btn-info view-btn">View</a></td>
            <td><a edit_id="<?php echo $single_teacher_data->id ?>" href="#" id="edit" class="btn btn-sm btn-primary">Edit</a></td>
            <td>
                <a delete_id="<?php echo $single_teacher_data->id ?>" href="#" class="btn btn-sm btn-danger delete-btn">
                    Delete
                </a>
            </td>
        </tr>
